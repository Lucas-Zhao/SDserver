...
/*CUSTOM FORMATS*/
Formats[1].unbanlist = ["Serperior-Mega", "Emboar-Mega", "Samurott-Mega", "Comfey-Mega", "Corviknight-Mega", "Ironclaw", "Dragapult-Mega", "Ironpod", "Shatterjaw", "Clashingteeth", "Galvantula-Mega", "Bronzong-Mega", "Runerigus-Mega", "Butterfree-Mega", "Dragonite-Mega-Z", "Florges-Mega-Love", "Noivern-Mega", "Serperior-Mega-Ivy", "Starmie-Mega", "Tropius-Mega", "Sirfetch’d-Mega", "Toxtricity-Mega", "Dusknoir-Mega", "Aurorus-Mega", "Tyrantrum-Mega", "Drapion-Mega", "Charizard-Mega-Z", "Charizard-Mega-A", "Clodsire-Mega", "Frostywaifu", "Chesnaught-Mega", "Delphox-Mega", "Greninja-Mega", "Irondetector", "Dragonite-Mega-A", "Emboar-Mega-Y", "Empoleon-Mega", "Samurott-Mega-Y", "Serperiorite", "Emboarite", "Samurottite", "Comfeyite", "Corviknightite", "Dragapultite", "Galvantulite", "Bronzongite", "Runerigusite", "Butterfrite", "Dragoniteite Z", "Florgesite Love", "Noivernite", "SerperioriteIvy", "Starmite", "Tropiusite", "Sirfetchdite", "Toxtricite", "Dusknoirite", "Aurorusite", "Tyrantrumite", "Drapionite", "Charizardite Z", "Charizardite A", "Clodsirite", "Chesnaughtite", "Delphoxite", "Greninjite", "Dragoniteite A", "Emboarite Y", "Empoleonite", "Samurottite Y"];
