...
/*CUSTOM FORMATS*/
Formats[1].unbanlist = ['Serperior-Mega', 'Emboar-Mega', 'Samurott-Mega', 'Dusknoir-Mega', 'Comfey-Mega', 'Corviknight-Mega', 'Clashingteeth', 'Irondetector', 'Frostywaifu', 'Ironclaw', 'Dragapult-Mega', 'Ironpod', 'Serperiorite', 'Emboarite', 'Samurottite', 'Dusknoirite', 'Comfeyite', 'Corviknightite', 'Dragapultite'];
